#Realizar una clase cuenta bancaria con los sig atr y met
#atr:  apellido, nombre, numero de cuenta, saldo de la cuenta
#metodos:
#constructor: saldo inicial en cero
#__str__ devolver todos los atributos
#saldo : mostrar el saldo de la cuenta
#ingresar monto: ingresar monto si es positivo
#retirar monto: retirar monto si es positivo y saldo suficiente
